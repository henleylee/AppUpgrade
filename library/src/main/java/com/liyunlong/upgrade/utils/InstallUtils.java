package com.liyunlong.upgrade.utils;
...
public class InstallUtils {
     ...
     */
    public static boolean mergePatch(Context context, String oldApkPath, String newApkPath, String patchPath, String newApkMD5) {
        ...
        try {
            ...
            copyFile(AppInfoUtils.getApkPath(context), oldApkPath, true);
